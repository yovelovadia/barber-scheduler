      ...
      <View style={styles.time_to_show}>
        <TouchableOpacity
          style={{
            flex: 1,
            backgroundColor:
              daysAndAllDays.timePicked === "all" ? colors.red : colors.grey,
          }}
          onPress={() =>
            setDaysAndAllDays({
        ...
        <TouchableOpacity
          style={{
            flex: 1,
            backgroundColor:
              daysAndAllDays.timePicked === "week" ? colors.red : colors.grey,
          }}
          onPress={() =>
            setDaysAndAllDays({
              allDays: [...daysAndAllDays.allDays],
        ...
        <TouchableOpacity
          style={{
            flex: 1,
            backgroundColor:
              daysAndAllDays.timePicked === "day" ? colors.red : colors.grey,
          }}
          onPress={() =>
            setDaysAndAllDays({
              allDays: [...daysAndAllDays.allDays],
...
const styles = StyleSheet.create({
  ...
  notFound: {color:"aliceblue", fontSize: 37, textAlign: "center", marginTop: 60 },
});
